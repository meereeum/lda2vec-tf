...
# def negative_sampling(x, t, W, vocabulary_size, sample_size):
...
# 	embed = tf.nn.embedding_lookup(W, x) # W == embeddings

# 	# Compute the average NCE loss for the batch.
# 	# tf.nce_loss automatically draws a new sample of the negative labels each
# 	# time we evaluate the loss.
# 	loss = tf.reduce_mean(
# 		tf.nn.nce_loss(nce_weights, nce_biases, embed, t,
...
class NegativeSampling():
	...
	def __init__(self, embedding_size, vocabulary_size, sample_size):
		...
		self.W = tf.Variable(
				...
				name="word_embeddings") # embeddings
